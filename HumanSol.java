/* Author: Dr. Walker
   Version 2
   The Human Solution class contains all of the instance variables and methods for a human
  */

public class HumanSol
{
   ...
   public HumanSol(String firstName, String lastName, String gender, String hair, String eye, String height, int age, double weeklyPay)
   {
